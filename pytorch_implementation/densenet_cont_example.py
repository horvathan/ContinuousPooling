...
class ContinuousPool(nn.Module):
    def __init__(self, in_channels, timesteps=10, type='max', ksize=2, strides=2, padding=1):
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('pool', ContinuousPool(num_output_features))  #nn.AvgPool2d(kernel_size=2, stride=2))
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ...
            ('pool0', ContinuousPool(64,ksize=2)), # nn.MaxPool2d(kernel_size=3, stride=2, padding=1)),
        ]))
